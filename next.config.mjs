...
const nextConfig = {
  ...
  async redirects() {
    return [
      // контейнеры
      {
        source: '/product/konteiner-s-size',
        destination: '/product/konteiner-dlia-maininga-na-36-mest',
        permanent: true,
        statusCode: 301,
      },
      {
        source: '/product/konteiner-l-size-40-futovyi',
        destination: '/product/konteiner-dlia-maininga-40-futov-na-264-mesta',
        permanent: true,
        statusCode: 301,
      },
      {
        source: '/product/konteiner-m-size-20-futovyi',
        destination: '/product/konteiner-dlia-maininga-20-futov-na-96-mest',
        permanent: true,
        statusCode: 301,
      },
      //
